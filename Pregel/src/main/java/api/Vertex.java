...
public class Vertex {
	...
	/**
	 * 
	 * @param vertexID Represents the pair object containing partitionID and vertexIdentifier
	 * @param outgoingEdges Represents the list of outgoing edges from the source vertex
	 */
